                        ...
                        return (
                            <tr>
                                ...
                                <td>
                                    ...
                                    <FaEdit onClick={() => editHandler(product)}
                                        color="blue"
                                        size={20} />
                                </td>
                            </tr>
            ...
            <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Body> {" "}
                    <div className='register-form'>
                        ...
                        <input className="form-control" type="text" placeholder="Image URL" value={product.imageURL} onChange={(e) => setProduct({ ...product, imageURL: e.target.value })} />
